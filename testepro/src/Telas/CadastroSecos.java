...
public class CadastroSecos extends JFrame {
	...
	public CadastroSecos() 
	{
		...
		setIconImage(Toolkit.getDefaultToolkit().getImage(CadastroFrioP.class.getResource("/imagens/icone secos.png")));
		setTitle("Cadastro de produtos secos");
		...
		try {
			...
			btnConfirma.addActionListener(new ActionListener() {
				...
				{
					secos.setDescricao(campoDescricao.getText());								
					secos.setMarca(campoMarca.getText());								
					secos.setQuantidade(Integer.parseInt(campoQuantidade.getText()));																
					secos.setValidade(campoValidade.getText());	
					
					if(secosBD.inserirSecos(secos))
					{
